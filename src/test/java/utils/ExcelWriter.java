...
public class ExcelWriter {
    ...
    private static final String SHEET_NAME =
            ConfigReader.getProperty("inventorySheet");
    ...
    public static void clearInventorySheet() {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Unable to clear Inventory Sheet",
                    e);
    ...
    public static void writeInventoryProducts(
        ...
        try {
            ...
            throw new RuntimeException(
                    "Unable to write Inventory Products",
                    e);
     ...
     * 7 = High-Low
     */
    public static void writeSortingResult(List<Product> products,
                                          int columnIndex) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Unable to write sorting result.",
                    e);
